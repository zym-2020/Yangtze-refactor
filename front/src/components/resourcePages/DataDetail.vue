            ...
            <el-row>
              <el-col :span="12">
                <div class="basicInfo-item">
                  <data-description
                    :data="{ key: '数据时间：', value: fileInfo?.time }"
                  ></data-description>
                </div>
              </el-col>
              <el-col :span="12">
              ...
              <el-row>
                ...
                >
                  <div class="type-item">
                    ...
                    <div class="type-item-bottom">
                      <el-button size="small" v-if="fileInfo?.getOnline">
                        下载
                      </el-button>
                      <el-button size="small" v-else @click="downloadOrigin">
                        添加订单
    ...
    <div class="right">
      ...
      <div class="explain">
        ...
        <el-card shadow="always" style="margin: 10px; margin-left: 60px">
          <div class="content" v-if="fileInfo?.getOnline">在线获取</div>

          <div class="content" v-if="!fileInfo?.getOnline">订单获取</div>
        </el-card>
      </div>
      <div class="Process">
        <div class="divider">
        ...
        <div class="online" v-if="fileInfo?.getOnline">
          <el-card shadow="always" style="margin: 10px; margin-left: 60px">
            <div class="content">[1]点击下载按钮</div>
          </el-card>
        </div>

        <div class="list" v-if="!fileInfo?.getOnline">
          <el-card shadow="always" style="margin: 10px; margin-left: 60px">
