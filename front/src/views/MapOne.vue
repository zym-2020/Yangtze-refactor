...
export default defineComponent({
  setup() {
    ...
    const openmaptiles: AnySourceData = {
      type: "vector",
      tiles: [`http://localhost:8003/osm/selectTile/{z}/{x}/{y}`],
    };
    const natural_earth_shaded_relief: AnySourceData = {
      maxzoom: 6,
      tileSize: 256,
      tiles: [
      ...
      map.value = new mapBoxGl.Map({
        ...
        style: {
          ...
          sources: {
            ...
            natural_earth_shaded_relief: natural_earth_shaded_relief,
          },
          sprite: "https://maputnik.github.io/osm-liberty/sprites/osm-liberty",
          glyphs:
            "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=XAapkmkXQpx839NCfnxD",
          layers: [
            {
              id: "background",
              type: "background",
            ...
            },
            {
              ...
              paint: {
                "line-color": {
                  ...
                  type: "interval",
                  stops: [
                    [{ zoom: 6, value: 0 }, "#000000"],
                    [{ zoom: 10, value: 0 }, "#000000"],
                  ],
                },
                "line-width": {
                  base: 1.4,
